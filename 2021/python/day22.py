...
def solve_1() -> int:
    ...
    for step in steps:
        ...
        x_range = range(max(-50, x_range_l[0]), min(x_range_l[1] + 1, 51))
        y_range = range(max(-50, y_range_l[0]), min(y_range_l[1] + 1, 51))
        z_range = range(max(-50, z_range_l[0]), min(z_range_l[1] + 1, 51))
